...
| 2026-07-02 | MinerU-Popo: Universal Post-Processing Model for Structured Document Parsing | [arXiv:2605.24973](https://arxiv.org/abs/2605.24973) | Document Parsing · OCR 后处理 · 标题树 · 跨页合并 | 在页级 OCR 之后用一个 4B 后处理模型分别处理文本截断、跨页表格、标题层级和图表关联，再由代码组装文档树；亮点是工程可控，边界是依赖上游 OCR 且规则过滤可能牺牲召回。 | [HTML](2026-07-02-mineru-popo.html) |
